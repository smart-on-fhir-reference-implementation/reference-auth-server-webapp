...
public class LaunchContextSessionListener implements HttpSessionListener {
    ...
    public void sessionDestroyed(HttpSessionEvent httpSessionEvent) {
        ...
        Set<String> sessionLaunchContextIds = (Set<String>)session.getAttribute(Constants.LAUNCH_CONTEXT_ID_MAP_KEY);
        LaunchContextHolder.clearGlobalContextMap(sessionLaunchContextIds);
    }
}
